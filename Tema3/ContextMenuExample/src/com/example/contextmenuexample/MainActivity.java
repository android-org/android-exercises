...
public class MainActivity extends Activity {
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		//Se pulso la Etiqueta: inflate de su menu
		...
		//Se pulso la Lista
			...
			// Set en el Header del Menu Contextual del texto del Item
			// seleccionado de la Lista, utilizando info adicional del Menu
			menu.setHeaderTitle(lstLista.getAdapter().getItem(info.position)
					.toString());
			//Inflate del Menu asociado a pulsar en la Lista
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		//Se identifica el item por el Id de los elementos todos los menus
